...
import { avatarStyle, containerStyle, headingStyle, paragraphStyle, smallDeviceButton, smallDeviceHeadingStyle, smallDeviceParagraphStyle, textStyle } from "./Styles"
